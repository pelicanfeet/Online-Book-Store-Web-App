...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/book/all").hasAnyRole("CUSTOMER", "EMP", "ADMIN")
				...
				.antMatchers("/confirmation").hasAnyRole("CUSTOMER", "EMP", "ADMIN")
				.antMatchers("/order").hasAnyRole("CUSTOMER", "EMP", "ADMIN")
				.antMatchers("/emptyShoppingCart/**").hasAnyRole("CUSTOMER", "EMP", "ADMIN")
				.antMatchers("/addToShoppingCart/**").hasAnyRole("CUSTOMER", "EMP", "ADMIN")
				.antMatchers("/placeOrder/**").hasAnyRole("CUSTOMER", "EMP", "ADMIN")
				.antMatchers("/purchaseOrder/detail/**").hasAnyRole("EMP", "ADMIN")
				.antMatchers("/purchaseOrder/all").hasAnyRole("EMP", "ADMIN")
